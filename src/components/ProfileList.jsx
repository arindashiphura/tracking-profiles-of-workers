...
const ProfileList = () => {
  ...
  const handleConfirmEdit = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/profiles/${editReview._id}`, {
        method: 'PUT',
        body: formData,
      });
      if (response.ok) {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/profiles/${deleteProfile._id}`, {
        method: 'DELETE',
      });
      if (response.ok) {
                  ...
                  {filteredProfiles.map((profile, idx) => (
                    <tr key={profile._id} className="hover:bg-gray-50">
                      ...
                      <td className="p-2 md:p-3 border border-gray-300 text-center">
                        {profile.photo ? (
                          <img src={`${import.meta.env.VITE_API_URL}/uploads/${profile.photo}`} alt="Profile" className="w-8 h-8 md:w-10 md:h-10 rounded-full object-cover mx-auto" />
                        ) : (
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0, 0, 0, 0.6)' }}>
          <div className="bg-white rounded-lg shadow-xl p-4 md:p-8 w-full max-w-md mx-4 relative">
            ...
            <div className="flex flex-col items-center mb-4">
              {viewProfile.photo ? (
                <img src={`${import.meta.env.VITE_API_URL}/uploads/${viewProfile.photo}`} alt="Profile" className="w-20 h-20 md:w-24 md:h-24 rounded-full object-cover mb-2" />
              ) : (
            ...
            <form onSubmit={handleEditSubmit}>
              <div className="flex flex-col items-center mb-4">
                {editProfile.photo && !editForm.photo ? (
                  <img src={`${import.meta.env.VITE_API_URL}/uploads/${editProfile.photo}`} alt="Profile" className="w-20 h-20 rounded-full object-cover mb-2" />
                ) : editForm.photo ? (
            ...
            <div className="flex flex-col items-center mb-4">
              {editReview.reviewPhoto ? (
                typeof editReview.reviewPhoto === 'string' ? (
                  <img src={`${import.meta.env.VITE_API_URL}/uploads/${editReview.reviewPhoto}`} alt="Profile" className="w-20 h-20 rounded-full object-cover mb-2" />
                ) : (
      ...
      {editSuccess && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0, 0, 0, 0.6)' }}>
          <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md relative">
            ...
            <div className="flex flex-col items-center mb-4">
              {editSuccess.photo ? (
                <img src={`${import.meta.env.VITE_API_URL}/uploads/${editSuccess.photo}`} alt="Profile" className="w-20 h-20 rounded-full object-cover mb-2" />
              ) : (
                <div className="w-20 h-20 rounded-full bg-gray-200 flex items-center justify-center mb-2">No Photo</div>
              )}
      ...
      {deleteProfile && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0, 0, 0, 0.6)' }}>
          <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md relative">
            ...
            <div className="flex flex-col items-center mb-4">
              {deleteProfile.photo ? (
                <img src={`${import.meta.env.VITE_API_URL}/uploads/${deleteProfile.photo}`} alt="Profile" className="w-20 h-20 rounded-full object-cover mb-2" />
              ) : (
                <div className="w-20 h-20 rounded-full bg-gray-200 flex items-center justify-center mb-2">No Photo</div>
              )}
